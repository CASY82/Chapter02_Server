/**
 *  멘토링 이후, 스케쥴러가 아닌 예약 시간을 기준으로 좌석 락을 거는 로직으로 변경
 */
...
//            }
//
//            Instant reservedAt = seatReservation.getReservedAt();
//            if (reservedAt == null || reservedAt.isAfter(Instant.now().minusSeconds(300))) {
//                continue;
//            }
//
